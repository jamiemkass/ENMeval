...
```{r envDownload, warning=FALSE, message=FALSE, fig.width = 8, fig.height = 8}
...
```{r removeCaribbean, message=FALSE, fig.width = 8, fig.height = 8}
...
```{r backgPts, fig.width = 6, fig.height = 6}
...
```{r part.block, fig.width = 6, fig.height = 6}
...
``` {r part.ck1, fig.width = 6, fig.height = 6}
...
``` {r part.ck2, fig.width = 6, fig.height = 6}
...
``` {r part.jk, fig.width = 6, fig.height = 6}
...
``` {r part.rand, fig.width = 6, fig.height = 6}
...
``` {r part.user1, fig.width = 6, fig.height = 6}
ngrps <- 10
...
``` {r part.user2, fig.width = 6, fig.height = 6}
...
``` {r part.user3, fig.width = 6, fig.height = 6}
...
``` {r stuff, fig.width = 6, fig.height = 6}
...
``` {r plot.pred1, fig.width = 6, fig.height = 6}
...
``` {r plot.pred2, fig.width = 7, fig.height = 7}
...
``` {r plot.pred3, fig.width = 7, fig.height = 7}
