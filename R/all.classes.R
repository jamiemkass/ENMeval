ENMevaluation <- setClass("ENMevaluation",
					   slots=c(results='data.frame',
					           predictions.raw='RasterStack',
					           predictions.log='RasterStack',
					           models='list',
...
setMethod("show",
		  ...
		  definition=function(object) {
		  	...
		  	cat(" ", "Occurrence/background points: ",
		  		...
		  		" ",  "@predictions.raw : RasterStack of raw model predictions", '\n',
		  		" ",  "@predictions.log : RasterStack of logistic model predictions", '\n',
